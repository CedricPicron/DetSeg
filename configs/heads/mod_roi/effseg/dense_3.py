            ...
            mask_logits_cfg=[
                ...
                *[dict(
                    ...
                    module_cfg=dict(
                        ...
                        module_cfg=[
                            ...
                            dict(
                                type='View',
                                out_shape=(-1, 2**(8-i), 2, 2, 14*(2**i), 14*(2**i)),
                            ),
                            dict(
                                type='Permute',
                                dims=[0, 1, 4, 2, 5, 3],
                            ...
                            dict(
                                type='Reshape',
                                out_shape=(-1, 2**(8-i), 28*(2**i), 28*(2**i)),
                            ),
                            dict(
                                type='nn.Conv2d',
                                in_channels=2**(8-i),
                ...
                *[dict(
                    ...
                    module_cfg=dict(
                        ...
                        mmdet_roi_ext_cfg=dict(
                            type='mmdet.SingleRoIExtractor',
                            roi_layer=dict(type='RoIAlign', output_size=28*(2**i), sampling_ratio=0),
                            out_channels=256,
                            featmap_strides=[4, 8, 16, 32][:(-i-1)],
                        ),
                    ),
                ) for i in range(3)],
                *[dict(
                ...
                *[dict(
                ...
                dict(
                    ...
                    module_cfg=[
                        ...
                        dict(
                            type='Add',
                            in_keys=['roi_feats', 'fuse_feats'],
                            out_key='roi_feats',
                        ),
                        dict(
                            type='StorageGetApply',
                            module_key='key_roi_ext',
                            id_key='iter_id',
                        ),
                        dict(
                            type='Cat',
