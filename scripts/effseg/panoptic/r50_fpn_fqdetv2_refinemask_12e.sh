...
exp_name=r50_fpn_fqdetv2_refinemask_12e
...
head_cfg=configs/gvd/sel_v387.py
...
--mmdet_core_cfg_path $core_cfg --heads cfg --head_cfg_paths $head_cfg --train_split 2017_train_panoptic \
--eval_split 2017_val_panoptic
