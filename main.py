...
def get_parser():
    ...
    parser.add_argument('--mbd_ca_rad_pts', default=1, type=int, help='number of CA radial points')
    ...
    parser.add_argument('--sbd_ca_rad_pts', default=1, type=int, help='number of CA radial points')
...
def main(args):
    ...
    param_families = ['sampling_offsets', 'steps', *param_families]
