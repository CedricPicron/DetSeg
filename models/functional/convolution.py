...
from models.functional.autograd import IdDeformConv2d
...
def id_deform_conv2d(in_core_feats, aux_feats, conv_ids, conv_weights, weight, bias):
    """
    Function implementing the 2D index-based deformable convolution operation.
    ...
    # Apply custom IdDeformConv2d autograd function
    out_core_feats = IdDeformConv2d.apply(in_core_feats, aux_feats, conv_ids, conv_weights, weight, bias)
