...
class SBD(nn.Module):
    ...
    def forward(self, feat_maps, tgt_dict=None, images=None, stand_alone=True, visualize=False, **kwargs):
        ...
        if stand_alone:
            ...
            return_list.append(self.visualize(images, pred_dicts, tgt_dict, **kwargs)) if visualize else None
    ...
    def visualize(self, images, pred_dicts, tgt_dict=None, vis_score_thr=0.4, **kwargs):
        """
