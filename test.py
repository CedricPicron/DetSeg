...
class TestModelsForward(unittest.TestCase):
    ...
    def test_backbone_forward(self):
        ...
        print(f"Memory backbone: {torch.cuda.max_memory_allocated()/(1024*1024): .0f} MB")
    ...
    def test_sine_position_forward(self):
        ...
        print(f"Memory sine pos: {torch.cuda.max_memory_allocated()/(1024*1024): .0f} MB")
    ...
    def test_encoder_forward(self):
        ...
        print(f"Memory encoder: {torch.cuda.max_memory_allocated()/(1024*1024): .0f} MB")
    ...
    def test_sample_decoder_forward(self):
        ...
        print(f"Memory sample decoder: {torch.cuda.max_memory_allocated()/(1024*1024): .0f} MB")
    ...
    def test_detr_forward(self):
        ...
        print(f"Memory full model: {torch.cuda.max_memory_allocated()/(1024*1024): .0f} MB")
